...
VOID EFIAPI DrawMenu(VOID)
{
  ...
  lv_win_set_title(win, "God BigfootACA!");
  ...
  lv_win_add_btn(win, SYMBOL_BLUETOOTH, reset_action);
  lv_win_add_btn(win, SYMBOL_DOWNLOAD, reset_action);
  lv_win_add_btn(win, SYMBOL_BATTERY_3, reset_action);
  lv_win_add_btn(win, SYMBOL_EJECT, reset_action);
